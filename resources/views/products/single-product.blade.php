      ...
      <div class="row">
              ...
              <div class="col-9">
                <div class="tab-content position-relative" id="v-pills-tabContent" style="background-color: white;">
                  <div class="product-wishlist">
                    <a wire:click="delete()" style="color: #f46a6a">
                      <i class="uil-trash"></i>
                    </a>
                  </div>
        ...
        <div class="col-xl-7">
          <div class="mt-4 mt-xl-3 ps-xl-4">
            <h5 class="font-size-14"><a href="ecommerce-product-detail.html#" class="text-muted">@if($category){{$category->name}}@endif</a></h5>
            <h4 class="font-size-20 mb-3">{{$product->name}} (Gray)</h4>
            ...
            <div>
              ...
              <div class="mt-3">
                ...
                <h5 class="font-size-14 mb-3"><i
                    class="uil uil-location-pin-alt font-size-20 text-primary align-middle me-2"></i> Delivery location
                </h5>
